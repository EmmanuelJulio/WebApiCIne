...
namespace WebApiPeliculas.Servicios
{
    public class AlmacenadorArchivosAzure : IAlmacenadorArchivos
    {
            ...
            string contenedor, string contentType)
        {
            ...
            var blubUploadOptions = new BlobUploadOptions();
            var blubHttpHeader = new BlobHttpHeaders();
            blubHttpHeader.ContentType = contentType;
            blubUploadOptions.HttpHeaders = blubHttpHeader;

            await blob.UploadAsync(new BinaryData(contenido), blubUploadOptions);
